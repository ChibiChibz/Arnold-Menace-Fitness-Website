import require$$0$3, { existsSync, readdirSync as readdirSync$1 } from 'fs';
...
const fs$7 = commonjsGlobal.__FAKE_TESTING_FS__ || require$$0$3;
...
if (!fs$4[gracefulQueue]) {
  ...
  if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || '')) {
    process.on('exit', function() {
      ...
      require$$0$2.equal(fs$4[gracefulQueue].length, 0);
    });
  }
}
